...
const zaloHref =
  'href="#elementor-action%3Aaction%3Dpopup%3Aopen%26settings%3DeyJpZCI6IjI0MjIiLCJ0b2dnbGUiOmZhbHNlfQ%3D%3D"';
content = content.replace(
  new RegExp(zaloHref, "g"),
  `href="#" onClick={(e) => { e.preventDefault(); setIsZaloOpen(true); }}`,
);

const contactHref =
  'href="#elementor-action%3Aaction%3Dpopup%3Aopen%26settings%3DeyJpZCI6IjY1OCIsInRvZ2dsZSI6ZmFsc2V9"';
content = content.replace(
  new RegExp(contactHref, "g"),
  `href="#" onClick={(e) => { e.preventDefault(); setIsContactOpen(true); }}`,
);

const split1 = content.split(
  '<div data-elementor-type="popup" data-elementor-id="658"',
);
...
const part2 =
  ...
  split2.slice(1).join("<script type='text/javascript'>");
                  ...
                  <div className="elementor-widget-icon-box" style={{ textAlign: 'center', paddingTop: 20 }}>
                      <div className="elementor-icon-box-wrapper">
                          <div className="elementor-icon-box-icon" style={{ marginBottom: 15 }}>
                              <a href="https://zalo.me/0857688626" target="_blank" rel="noreferrer" className="elementor-icon">
                          ...
                          <div className="elementor-icon-box-content">
                              <h3 className="elementor-icon-box-title" style={{ margin: '10px 0' }}>
                                  <a href="https://zalo.me/0857688626" target="_blank" rel="noreferrer" style={{ textDecoration: 'none', color: '#333', fontSize: 24, fontWeight: 'bold' }}>Zalo</a>
                              </h3>
                              <p className="elementor-icon-box-description" style={{ margin: 0 }}>
                                  <a href="https://zalo.me/0857688626" target="_blank" rel="noreferrer" style={{color: '#666', textDecoration: 'none', fontSize: 18}}>0857.688.626</a>
                              </p>
                          </div>
                      </div>
                  </div>
